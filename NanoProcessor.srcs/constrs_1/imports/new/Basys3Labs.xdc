...
#set_property PACKAGE_PIN W18 [get_ports {tmp[0]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {tmp[0]}]
#set_property PACKAGE_PIN U15 [get_ports {tmp[1]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {tmp[1]}]
#set_property PACKAGE_PIN U14 [get_ports {tmp[2]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {tmp[2]}]
#set_property PACKAGE_PIN V14 [get_ports {tmp[3]}]
