...
set_property PACKAGE_PIN W18 [get_ports {R7_out[4]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {R7_out[4]}]
set_property PACKAGE_PIN U15 [get_ports {R7_out[5]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {R7_out[5]}]
set_property PACKAGE_PIN U14 [get_ports {R7_out[6]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {R7_out[6]}]
set_property PACKAGE_PIN V14 [get_ports {R7_out[7]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {R7_out[7]}]
...
#set_property PACKAGE_PIN U3 [get_ports {tmp[0]}]
...
set_property PACKAGE_PIN N3 [get_ports {Parity}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Parity}]
set_property PACKAGE_PIN P1 [get_ports {Zeroes}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Zeroes}]
